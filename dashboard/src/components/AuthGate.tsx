...
export function AuthGate({ children }: { children: React.ReactNode }) {
  ...
  return (
    <Dialog.Root open modal>
      <Dialog.Portal>
        <Dialog.Overlay className="fixed inset-0 z-50 bg-page/95 backdrop-blur-sm" />
        <Dialog.Content
          className="fixed top-1/2 left-1/2 z-50 w-full max-w-lg -translate-x-1/2 -translate-y-1/2 rounded-md border border-white/10 bg-chip p-6 shadow-2xl outline-none"
        ...
        >
          <form onSubmit={onSubmit}>
            ...
            <input
              ...
              className="w-full rounded border border-white/10 bg-page px-3 py-2 font-mono text-sm text-white outline-none focus:border-sky-500"
            />
